...
public class Tavolo extends TableImpl<TavoloRecord> {
    ...
    private Tavolo(Name alias, Table<TavoloRecord> aliased) {
        this(alias, aliased, null);
    }

    private Tavolo(Name alias, Table<TavoloRecord> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> Tavolo(Table<O> child, ForeignKey<O, TavoloRecord> key) {
    ...
    @Override
    public Tavolo as(String alias) {
        return new Tavolo(DSL.name(alias), this);
    }

    @Override
    public Tavolo as(Name alias) {
        return new Tavolo(alias, this);
    }

    @Override
    public Tavolo as(Table<?> alias) {
        return new Tavolo(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public Tavolo rename(String name) {
        return new Tavolo(DSL.name(name), null);
    }
     ...
     */
    @Override
    public Tavolo rename(Name name) {
        return new Tavolo(name, null);
    }
     ...
     */
    @Override
    public Tavolo rename(Table<?> name) {
        return new Tavolo(name.getQualifiedName(), null);
    }
